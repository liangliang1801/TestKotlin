...
final public class ApkUtil {
    ...
    public static boolean hasV2SignBlock(File apkFile) throws IOException{
        ...
        try {
            ...
            final ByteBuffer apkSigningBlock2 = apkSigningBlockAndOffset.first;
            ...
            return apkSignatureSchemeV2Block != null;
